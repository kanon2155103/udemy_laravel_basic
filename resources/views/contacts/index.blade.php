        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
									<a href="{{ route('contacts.create') }}" class="text-blue-500">New</a> <!-- tailwindcss -->
									<form method="get" action="{{ route('contacts.index') }}" class="mt-2">
							      ...
							      <table class="table-auto w-full text-left whitespace-no-wrap">
							        <thead>
							          <tr>
							            ...
							            <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">Submitted</th>
							        ...
							        <tbody>
							          ...
							          <tr>
							            ...
							            <td class="border-t-2 border-gray-200 px-4 py-3 text-lg text-gray-900 text-blue-500"><a href="{{ route('contacts.show', [ 'id' => $contact->id ]) }}">View</a></td> <!-- パラメータを第二引数に　-->
							          </tr>
												@endforeach
							        </tbody>
							      </table>
